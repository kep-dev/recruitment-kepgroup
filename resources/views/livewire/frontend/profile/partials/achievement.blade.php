            ...
            <div
                ...
                <div
                    ...
                    <div
                        ...
                        <button type="button" @click="$wire.updateAchievement" wire:loading.attr="disabled"
                            wire:target="updateAchievement"
                            class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-hidden focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none">
                            <!-- Teks normal -->
                            <span wire:loading.remove wire:target="updateAchievement">
                                Save changes
                            </span>

                            <!-- Teks saat loading -->
                            <span wire:loading wire:target="updateAchievement" class="flex items-center gap-2">
