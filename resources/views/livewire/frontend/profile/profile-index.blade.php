<div>
    ...
    <main class="w-full max-w-7xl md:pt-0 px-4 sm:px-6 lg:px-8 mx-auto">
        <div class="grid grid-cols-12 gap-4">
            <div style="height: max-content"
                ...
                <nav
                    ...
                    <div class=" pb-0 px-2  w-full flex flex-col flex-wrap">
                        <ul class="space-y-1">
                            <li>
                                <a class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-800 dark:text-slate-100 rounded-lg hover:bg-neutral-100 focus:outline-hidden focus:bg-gray-100 gray:bg-neutral-700 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700 @if ($page == 'frontend.profile.page.my-profile') dark:bg-neutral-700 bg-neutral-200 @endif"
                                    href="javascript:;" @click="$wire.$set('page', 'frontend.profile.page.my-profile')">
                            ...
                            <li>
                                <a class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-800 dark:text-slate-100 rounded-lg hover:bg-neutral-100 focus:outline-hidden focus:bg-gray-100 gray:bg-neutral-700 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700 @if ($page == 'frontend.profile.page.my-application') dark:bg-neutral-700 bg-neutral-200 @endif"
                                    href="javascript:;"
                                    @click="$wire.$set('page', 'frontend.profile.page.my-application')">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"
                                        stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <li>
                                <a class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-800 dark:text-slate-100 rounded-lg hover:bg-neutral-100 focus:outline-hidden focus:bg-gray-100 gray:bg-neutral-700 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700 @if ($page == 'frontend.profile.page.saved-vacancy') dark:bg-neutral-700 bg-neutral-200 @endif"
                                    href="javascript:;"
                                    @click="$wire.$set('page', 'frontend.profile.page.saved-vacancy')">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"
                                        stroke-linecap="round" stroke-linejoin="round"
            ...
            <livewire:is :component="$page" :key="$page" :user="$user" />
