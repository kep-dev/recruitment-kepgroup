@props([
    'modalId' => 'hs-danger-alert',
    'title' => 'Delete personal account',
    'message' =>
        'Are you sure you want to delete your personal account? All of your data will be permanently removed. This action cannot be undone.',
    'action' => null,
])

<div id="{{ $modalId }}"
    class="hs-overlay hidden size-full fixed top-0 start-0 z-80 overflow-x-hidden overflow-y-auto" role="dialog"
    tabindex="-1" aria-labelledby="{{ $modalId }}-label" wire:ignore wire:ignore.self>
    <div
