...
<head>
    ...
    <meta name="twitter:title" content="Recruitment KEP Group">
    ...
    <meta property="og:title" content="Recruitment KEP Group">
...
<body class="dark:bg-neutral-900">
    ...
    <main id="content">
        ...
        <div class="px-4 sm:px-6 lg:px-8 ">
            <div
                class="h-120 md:h-[80dvh] flex flex-col bg-[url('{{ asset('images/include/bgjdih.jpg') }}')] bg-cover bg-center bg-no-repeat rounded-2xl">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
                    ...
                    <div class="relative">
                        <div class="aspect-4/4 overflow-hidden rounded-2xl">
                            <img class="size-full object-cover rounded-2xl"
                                src="https://preline.co/assets/img/pro/coffee-shop/img1.png" alt="Product Image">
                        </div>
                        ...
                        <div class="flex flex-col">
                            ...
                            <div class="py-3 border-t border-gray-200 dark:border-neutral-700">
                                <div class="grid grid-cols-2 gap-2">
                                    <div>
                                        <span class="font-medium text-black dark:text-white">Tasting Notes:</span>
                                    </div>

                                    <div class="text-end">
                                        <span class="text-black dark:text-white">Hazelnut, Grape, Milk Chocolate</span>
                                    </div>
                                </div>
                            </div>
                            <!-- End Item -->
                            ...
                            <div class="py-3 border-t border-gray-200 dark:border-neutral-700">
                                <div class="grid grid-cols-2 gap-2">
                                    <div>
                                        <span class="font-medium text-black dark:text-white">Origin:</span>
                                    </div>

                                    <div class="flex justify-end">
                                        <span class="text-black dark:text-white">Brazil</span>
                                    </div>
                                </div>
                            </div>
                            <!-- End Item -->
                            ...
                            <div class="py-3 border-t border-gray-200 dark:border-neutral-700">
                                <div class="grid grid-cols-2 gap-2">
                                    <div>
                                        <span class="font-medium text-black dark:text-white">Region:</span>
                                    </div>

                                    <div class="text-end">
                                        <span class="text-black dark:text-white">San Paulo</span>
                                    </div>
                                </div>
                            </div>
                            <!-- End Item -->
                ...
                <div class="group flex flex-col">
                    <div class="relative">
                        <div class="aspect-4/4 overflow-hidden rounded-2xl">
                            <img class="size-full object-cover rounded-2xl"
                                src="https://preline.co/assets/img/pro/coffee-shop/img2.png" alt="Product Image">
                        </div>
                        ...
                        <div class="flex flex-col">
                            ...
                            <div class="py-3 border-t border-gray-200 dark:border-neutral-700">
                                <div class="grid grid-cols-2 gap-2">
                                    ...
                                    <div class="text-end">
                                        <span class="text-black dark:text-white">Red Apple, Caramel, Aimond</span>
                                    </div>
                                </div>
                            </div>
                            <!-- End Item -->
                            ...
                            <div class="py-3 border-t border-gray-200 dark:border-neutral-700">
                                <div class="grid grid-cols-2 gap-2">
                                    ...
                                    <div class="flex justify-end">
                                        <span class="text-black dark:text-white">Colombia</span>
                                    </div>
                                </div>
                            </div>
                            <!-- End Item -->
                            ...
                            <div class="py-3 border-t border-gray-200 dark:border-neutral-700">
                                <div class="grid grid-cols-2 gap-2">
                                    ...
                                    <div class="text-end">
                                        <span class="text-black dark:text-white">Manizales</span>
                                    </div>
                                </div>
                            </div>
                            <!-- End Item -->
                ...
                <div class="group flex flex-col">
                    <div class="relative">
                        <div class="aspect-4/4 overflow-hidden rounded-2xl">
                            <img class="size-full object-cover rounded-2xl"
                                src="https://preline.co/assets/img/pro/coffee-shop/img5.png" alt="Product Image">
                        </div>
                        ...
                        <div class="flex flex-col">
                            ...
                            <div class="py-3 border-t border-gray-200 dark:border-neutral-700">
                                <div class="grid grid-cols-2 gap-2">
                                    ...
                                    <div class="text-end">
                                        <span class="text-black dark:text-white">Red Apple, Walnut, Milk
                                            Chocolate</span>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="group flex flex-col">
                    <div class="relative">
                        <div class="aspect-4/4 overflow-hidden rounded-2xl">
                            <img class="size-full object-cover rounded-2xl"
                                src="https://preline.co/assets/img/pro/coffee-shop/img7.png" alt="Product Image">
                        </div>
                ...
                <div class="group flex flex-col">
                    <div class="relative">
                        <div class="aspect-4/4 overflow-hidden rounded-2xl">
                            <img class="size-full object-cover rounded-2xl"
                                src="https://preline.co/assets/img/pro/coffee-shop/img3.png" alt="Product Image">
                        </div>
                        ...
                        <div class="flex flex-col">
                            ...
                            <div class="py-3 border-t border-gray-200 dark:border-neutral-700">
                                <div class="grid grid-cols-2 gap-2">
                                    ...
                                    <div class="text-end">
                                        <span class="text-black dark:text-white">Apricot, Cashew, Praline</span>
                                    </div>
                                </div>
                            </div>
                            <!-- End Item -->
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 md:items-center">
                    ...
                    <div class="pt-10 md:p-10">
                        <blockquote class="max-w-4xl mx-auto">
                            ...
                            <p
                                class="text-xl sm:text-2xl lg:text-3xl lg:leading-normal text-gray-800 dark:text-neutral-200">
        ...
        <div class="w-full max-w-7xl py-10 md:pt-0 px-4 sm:px-6 lg:px-8 mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 items-center gap-5">
                <div class="text-center md:text-start">
                    <!-- Logo -->
                    <svg class="w-24 h-auto mx-auto md:mx-0" width="116" height="32" viewBox="0 0 116 32"
                ...
                <ul class="text-center">
                    <li
                        ...
                        <a class="inline-flex gap-x-2 text-sm text-black hover:text-gray-600 dark:text-white dark:hover:text-neutral-300"
                            href="#">
                            About
                        </a>
                    </li>
                ...
                <div class="text-center md:text-end space-x-2">
                    <a class="size-8 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent text-black hover:text-gray-600 disabled:opacity-50 disabled:pointer-events-none dark:text-white dark:hover:text-neutral-400"
                        href="#">
