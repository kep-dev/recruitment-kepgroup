    ...
    <div class="col-span-full md:col-span-full lg:col-span-9">
                    ...
                    @foreach ($this->skills as $skill)
                        <span
                            ...
                            <button type="button" class="shrink-0 text-gray-500 hover:text-red-600"
                                @click="$wire.deleteSkill('{{ $skill->id }}')">
        ...
        <div id="latestSkill"
            ...
            role="dialog" tabindex="-1" aria-labelledby="latestSkill-label" wire:ignore wire:ignore.self>
            <div
                ...
                <div
                    ...
                    <div
                        ...
                        <h3 id="latestSkill-label" class="font-bold text-gray-800 dark:text-white">
                            Keahlian
                        </h3>
                        <button type="button"
                            class="size-8 inline-flex justify-center items-center gap-x-2 rounded-full border border-transparent bg-gray-100 text-gray-800 hover:bg-gray-200 focus:outline-hidden focus:bg-gray-200 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-700 dark:hover:bg-neutral-600 dark:text-neutral-400 dark:focus:bg-neutral-600"
                            aria-label="Close" data-hs-overlay="#latestSkill">
                    ...
                    <div class="p-4 overflow-y-auto">
                        <div class="space-y-4">
                            <div class="max-w-full">
                                <label for="skill"
                                    class="block text-sm font-medium mb-2 dark:text-white">Keahlian</label>
                                <input wire:model='skill' type="text" id="skill"
                                    placeholder="Cont. Laravel, Python, Excel, Word, dll"
        ...
        @script
            <script>
                const modal = document.getElementById('latestSkill')

                document.addEventListener('addSkill', (e) => {
                    HSOverlay.open('#latestSkill');
                })

                document.addEventListener('closeModal', () => {
                    HSOverlay.close('#latestSkill')
                })
