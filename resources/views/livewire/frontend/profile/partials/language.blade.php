            ...
            <div
               ...
               dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
                    ...
                    <div
                        ...
                        <button type="button" @click="$wire.updateLanguage" wire:loading.attr="disabled"
                            wire:target="updateLanguage"
                            class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-hidden focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none">
                            <!-- Teks normal -->
                            <span wire:loading.remove wire:target="updateLanguage">
                                Save changes
                            </span>

                            <!-- Teks saat loading -->
                            <span wire:loading wire:target="updateLanguage" class="inline-flex items-center gap-2">
